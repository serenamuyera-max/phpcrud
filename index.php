...
<!--Fetch the Records -->
 ...
 <td>
 <a href="read.php?viewid=<?php echo htmlentities ($row['ID']);?>" class="view" title="View" datatoggle="tooltip"><i class="material-icons">&#xE417;</i></a>
...
data-toggle="tooltip" onclick="return confirm('Do you really want to Delete ?');"><i class="materialicons">&#xE872;</i></a>
 </td>
 </tr>
 <?php
$cnt=$cnt+1;
